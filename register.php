...
<div class="loginBox">
	<div class="login_cont">
		...
		<br/>
	<form method="post"  action="doAction.php?act=regist" onsubmit="return check()">
		<ul class="login">
			<div class="dropdown">
			...
			<li class="l_tit">password</li>
			<li class="mb_10"><input id="pass" type="password" name="password2" class="login_input user_icon"></li>
			<input type="submit" value="regist" class="login_btn">					
		</ul>
		</form>		
	</div>
</div>
